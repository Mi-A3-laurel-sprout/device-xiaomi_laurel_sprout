...
BOARD_LAUREL_DYNAMIC_PARTITIONS_SIZE := $(shell expr $(BOARD_SUPER_PARTITION_SIZE) - 4194304 )
BOARD_LAUREL_DYNAMIC_PARTITIONS_PARTITION_LIST := system vendor system_ext odm product
